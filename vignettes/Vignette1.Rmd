...
The second input file is the kinship matrix to control inbreeding. Based on simulation results (Endelman 2024), the pedigree IBD kinship matrix is recommended for either OCS or OMA. The kinship matrix for the potato clones was generated using R package [AGHmatrix](https://cran.r-project.org/web/packages/AGHmatrix/index.html).
